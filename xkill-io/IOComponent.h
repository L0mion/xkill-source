...
private:
	...
	void loadMD5AssembleAnimation(std::string name, std::map<std::string, AnimationClip*>* animations, LoaderMD5AnimationDesc* md5Animation, LoaderMD5ModelDesc* md5Model);
