...
void NameGenerator::resetNames()
{
	...
	addName("3 wireless gamepads in a bag");
	addName("the former truth");
	addName("as time goes by");
	addName("thank me later");
	addName("I'm only imploding");
	addName("clock workaround");
	addName("dead airliner");
	addName("jazzmobile");
	addName("Godzilla having a fever");
	addName("justifiable homicide");
	addName("eucalyptic juice");
	addName("the bells are ringing");
	addName("for all intents and purposes");
	addName("those pesky unpleasants");
	addName("rumbling egg yolk");
	addName("smoking chimney");
	addName("firmament to fin");
	addName("shuffle that deck again");
	addName("that was rad");
	addName("the way it should be");
	addName("the other way around");
	addName("penitentiary in a treehouse");
	addName("flooded dam");
	addName("uninvited mayor");
	addName("dehydrated water wheel");
	addName("body of water");
	addName("unopened letters with stamp");
	addName("Mr. Hyde in formaldehyde");
	addName("was that you in that picture?");
	addName("worried about the future");
	addName("incorrectly thought plan");
	addName("famous plan b");
